...
2. Sort `flights` to 
    ...
    a. find the flight that left earliest
    b. find the most delayed flight
    c. find the flight that travelled the longest and that travelled the shortest
...
4. Use `mutate()` to
    ...
    a. Create new variables for `dep_time` and `sched_dep_time` that measure times in the number of minutes.
